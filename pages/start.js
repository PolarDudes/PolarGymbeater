...
import {SafeAreaView, StyleSheet, TextInput, Button, View, Alert, TouchableOpacity, Text} from 'react-native';
...
<TouchableOpacity onPress={()=>checkSwitch(selectedActivity)} activeOpacity={0.6} style={styles.button} >
<Text>INFO</Text>
</TouchableOpacity>
